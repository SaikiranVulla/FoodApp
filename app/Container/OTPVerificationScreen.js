...
const OTPVerificationScreen = () => {
  ...
  return (
    <CommonSheetView mainTitle={'Verification'} subTitle={'We have sent a code to your email example@gmail.com'}>
      <View style={styles.resendContainer}>
       <Text style={styles.codeText}>Code</Text>
       <TouchableOpacity activeOpacity={0.7} disabled={countdown > 0} onPress={handleResend} style={styles.resendView}>
        <Text style={styles.resendText}>Resend </Text>
        <Text style={styles.countdownText}>{countdown > 0 ? `in ${countdown} sec` : ''}</Text>
       </TouchableOpacity>
      </View>
